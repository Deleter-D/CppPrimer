...
int main(int argc, char const *argv[])
{
    ...
    {
        cout << "found number at index " << pos << " element is " << name2[pos] << endl;
        ++pos;
    }
    ...
    string pi = "pi = 3.14!!!";
    d = stod(pi.substr(pi.find_first_of("+-.0123456789"))); // 等价于d = stod("3.14!!!")
...
/*
    ...
    pos1, n1, cp           | 将s中从posl开始的nl个字符与cp指向的以空字符结尾的字符数组进行比较
...
/*
    ...
    stol(s, p, b)   | 分别是int、long、unsigned long、long long、unsigned long long
